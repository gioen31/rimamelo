...
const rimeCoppieEasy = [
    ...
    ['lesbica', 'tecnica'],
    ['richiesta', 'festa'],
    ['esista', 'spogliarellista'],
    ['attenta', 'leggenda'],
    ['schiavitù', 'tiramisù'],
    ['underground', 'lockdown'],
    ['cavalletto', 'complimento'],
    ['funzionerà', 'personalità'],
    ['rallenta', 'sigaretta'],
    ['capibara', 'mascara'],
    ['facciamo', 'cacciato'],
    ['amarena', 'sirena'],
    ['chili', 'profili'],
    ['pomodoro', 'tesoro'],
    ['purgatorio', 'accessorio'],
    ['stropicciato', 'affogato'],
    ['sciacalli', 'tergicristalli'],
    ['povera', 'dermatologa'],
    ['accorgerai', 'benzinai'],
    ['estinti', 'recinti'],
    ['scintille', 'tonsille'],
    ['speranza', 'danza'],
    ['sculture', 'sfumature'],
    ['alimentazione', 'stagione'],
    ['colori', 'ammortizzatori'],
    ['amaro', 'sipario'],
    ['vento', 'attento'],
    ['sguardo', 'baluardo'],
    ['caldo', 'scalzo'],
